...
const (
	...
	// ChannelConditionDeadLetterSinkResolved has status true when this Channel spec delivery
	// DeadletterSink is defined with a valid Destination or URI
...
func (cs *ChannelStatus) MarkDeadLetterSinkResolvedSucceeded(deadLetterSinkURI *apis.URL) {
	cs.DeadLetterSinkURI = deadLetterSinkURI
